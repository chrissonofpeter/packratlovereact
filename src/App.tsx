...
2. navigate to secretspaces directory
...
function App() {
  ...
  */
  ...
  const addBoxToList = (b) => {

    let tempArr: any[] = boxList;
    tempArr.push(b);
    setBoxList(tempArr);
    setValue("a new box added");
  };
  ...
  var createBox = () => {
    ...
    var box = BABYLON.MeshBuilder.CreateBox("box" + (count+1), { size: 2 }, null);
    box.position.x = Math.random() * (30) + 1;
    box.position.y = Math.random() * (30) + 1;
    box.position.z = Math.random() * (30) + 1;
